...
namespace PLAYGROUND
{
    public class Canvas
    {
        ...
        public void ApplyFilter(Action<byte[], int, int, int, int, float[,]> filterFunction, float[,] depthBuffer)
        {
            filterFunction(bits, (int)Width, (int)Height, stride, pixelFormatSize, depthBuffer);
